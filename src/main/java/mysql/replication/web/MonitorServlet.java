...
import mysql.replication.Monitor;
import mysql.replication.Tuple;
...
public class MonitorServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String[] mySQLBinlogInfo = mysqlLogOffset.split(":");

        if( !mySQLBinlogInfo[0].equals( monitorData.logfileName ) ||  ( monitorData.logfileOffset - Long.parseLong(mySQLBinlogInfo[1])) >= 10000 ){
            writer.write("warring\n");
        }
